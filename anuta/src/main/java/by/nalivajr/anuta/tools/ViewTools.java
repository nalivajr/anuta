...
import by.nalivajr.anuta.exceptions.NotAnnotatedFragmentUsedException;
...
public final class ViewTools {
    ...
    public static final String TAG = String.format("%s.%s", Anuta.class.getSimpleName(), ViewTools.class.getSimpleName());
