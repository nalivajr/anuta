 ...
 */
public abstract class AnutaAbstractAdapter<T> extends BaseAdapter {

    private LayoutInflater inflater;
    private Map<Integer, List<Integer>> typeToIdsMap = new HashMap<Integer, List<Integer>>();

    /**
     * Creates instance of {@link AnutaAbstractAdapter}
     ...
     *                                 of model object
     */
    public AnutaAbstractAdapter(Context context, Map<Integer, List<Integer>> layoutIdToSubViewsIdsMap) {
